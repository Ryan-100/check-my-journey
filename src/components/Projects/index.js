    ...
    <Container id="projects">
      <Wrapper>
        ...
        <ToggleButtonGroup >
          ...
          <Divider />
          {toggle === 'freelance' ?
            <ToggleButton active value="freelance" onClick={() => setToggle('freelance')}>Freelance</ToggleButton>
            :
            <ToggleButton value="freelance" onClick={() => setToggle('freelance')}>Freelance</ToggleButton>
          }
            <Divider />
          {toggle === 'school pj' ?
